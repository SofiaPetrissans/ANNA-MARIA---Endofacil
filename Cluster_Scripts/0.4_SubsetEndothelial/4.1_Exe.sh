#!/bin/bash
#SBATCH --job-name=Annotate_Remove
#SBATCH --array=1-3
#SBATCH --output=logs/Annotate_Remove_%A_%a.out
#SBATCH --error=logs/Annotate_Remove_%A_%a.err
...
Rscript 4.0_Markers_Annotation.R $THRESHOLD $RESOLUTION $TYPE
