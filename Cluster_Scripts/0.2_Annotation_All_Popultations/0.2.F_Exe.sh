...
#SBATCH --output=logs/Plots_AUCell_%A_%a.out
#SBATCH --error=logs/Pltos_AUCell_%A_%a.err
#SBATCH --array=1-6
...
# EJECUTAR SCRIPT R
# --------------------------
Rscript 0.2.E_GeneratePlots_AUCell_Int.R $THRESHOLD $RESOLUTION
