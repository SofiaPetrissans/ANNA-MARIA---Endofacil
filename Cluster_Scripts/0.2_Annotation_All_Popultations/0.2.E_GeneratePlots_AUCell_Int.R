...
auc_dir <- file.path(path.guardar_original, "2.Annotations_Integrated", THRESHOLD, paste0("res", RESOLUTION), "AUCell")
output_dir <- file.path(path.guardar_original, "2.Annotations_Integrated", THRESHOLD, paste0("res", RESOLUTION), "Plots_AUCell")
